...
namespace SessionApp1.DayEight
{
    internal class FileOperator
    {
        ...
        public static void ListDirectoryContent() // displays all the folders
        {
        ...
        public static void ShowCurrentDirectory() //displays the current directory where the exe is running
        {
            String currentworkingdirectory = Directory.GetCurrentDirectory(); // method 1
            Console.WriteLine(currentworkingdirectory);

            currentworkingdirectory = Environment.CurrentDirectory; // method 2 
            Console.WriteLine(currentworkingdirectory);
        }
    ...
    public static void StreamWriterDemo()

        {
            ...
            using (StreamWriter sw = new StreamWriter(fName)) // streamWriter - by default it overwrites the data , to append use 
                                                             //  StreamWriter(fName, true) - to append the data not to overwrite
