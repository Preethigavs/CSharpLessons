...
namespace SessionApp1.DayFive
{
    internal class RefClass
    {
        ...
        //out parameter
        public static void OutParameterMethod(int v1, out int v2, out int v3)
        {
            ...
            v3 = v1 * 10;
            Console.WriteLine("\t M2==> v1={0},v2={1} , v3={2}", v1, v2, v3);
        }
        public static void TestOutParameter()
        {
            ...
            Console.WriteLine("Before M2==> x={0},y={1}", x, y, z); // 5, 10
            OutParameterMethod(x, out y, out z);
            //M2(v2: out x, v1: y);//Using Named Arguments
            Console.WriteLine("After M2==> x={0},y={1}", x, y, z);// 5, 525
        }
        ...
        //public static int Add(int v1,int v2, out  int v3)
        //{
