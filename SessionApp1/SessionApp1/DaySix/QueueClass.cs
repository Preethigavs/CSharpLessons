...
namespace SessionApp1.DaySix
{
    internal class QueueClass
    {
        ...
        public static void EmpHTDemo() // hashtable
        {
        ...
        public static void HashtableDemo() // hashtable
        {
        ...
        public static void TestSortedListA() // sortedList
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                if (!slist.ContainsKey(x))
                    slist.Add(x, i * x); // sorting is based in key no by the value
                Console.Write(x + " ");
            }
            Console.WriteLine();
